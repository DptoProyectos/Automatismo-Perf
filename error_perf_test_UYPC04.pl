...
#VARIABLES DE CONFIGURACION QUE SE GUARDAN EN REDIS
	my $DLGID = "UYPC04";									# ID DATALOGGER A TESTEAR
	my $TYPE = 'TQ';										# TIPO DE INSTALACION {PERF_AND_TQ | PERF | TQ | OTHER }
...
#VARIABLES DE CONFIGURACION QUE SE CARGAN
	...
	my $TEST_OUTPUTS = 'NO';								# PARA TESTEAR LAS SALIDAS Y EN CASO DE TRES ERRORES CONSECUTIVOS REINICIAR => 'OK'
	my $EVENT_DETECTION = 'NO';								# SE USA PARA DEJAR REGISTRADOS CIERTOS EVENTOS DE LAS PERFORACIONES { SI | NO }
	my $test_emergency_system = 'SI';						# PARA TESTEAR EL SISTEMA DE EMERGENCIA ( BOYAS O TIMERS) { SI | NO }
	my $TEST_SOURCE = 'NO';									# SE ELIGE SI SE QUIERE TESTEAR LA FUENTE DEL TABLERO DE LA PERFORACION { SI | NO }
	#
	#
